...
class YSATest():
    ...
    def __init__(self):
        ...
        self.loadedFeatureTumor5 = np.load('hasta1_featureTumor_{}.npy'.format(self.patch_boyut))
        self.loadedFeatureArka5 = np.load('hasta1_featureArkaplan_{}.npy'.format(self.patch_boyut))
